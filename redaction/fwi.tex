...
\begin{figure}[!h]
	\centering
	\begin{tikzpicture}
		\node at(4.3,-1) {\includegraphics[scale=0.0365]{img/anisotrope2.png}};
		\draw (0,0) -- (9,0) ;
		\draw (0,-2) -- (9,-2) ;
...
\end{figure} 
    \todo[inline]{terminologie : field : champ ? / ray-based reflection tomography : tomographie en réflexion ?}
    \todo[inline]{quelles types de sources ?}
...
Les problématiques du CND de soudure par FWI sont liées à quelques nouvelles spécificités, propre à cette application, qui sont : 
\begin{itemize}
